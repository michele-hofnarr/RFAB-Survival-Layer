...
RANGES = {
    ...
    "fCurePotency": (0, 100, 5),
    "fCoughRateMult": (0.1, 5.0, 0.1),
    "fCoughVolume": (0.0, 1.0, 0.05),
    "fDiseaseProgressHours": (5, 120, 5),
    "fDiseaseDecayHours": (5, 240, 5),
    "fDiseaseHitChance": (0, 100, 5),
    "fFoodPoisonChance": (0, 100, 5),
    "fRawFoodStaggerForce": (0.0, 1.0, 0.05),
    "fColdCatchAt": (0.0, 1.0, 0.05),
    "fColdCatchWorstAt": (0.0, 1.0, 0.05),
    "fColdCatchChanceMin": (0, 100, 5),
    "fColdCatchChanceMax": (0, 100, 5),
    "fElemLesionColdAt": (0.0, 1.0, 0.05),
    "fElemLesionHypoChance": (0, 100, 5),
    "fElemLesionHitP": (-20, 0, 1),
    "fElemLesionContractP": (10, 100, 5),
    ...
    "fHypoDrainRamp": (5, 120, 5),

    "fPenaltyPrimary": (0, 100, 5),
    "fPenaltyCross": (0, 100, 5),
    "fPenaltySpeed": (0, 50, 5),
    "fSpeedCap": (0, 80, 5),
    "fPenaltyCap": (0, 95, 5),
    "fTierStep": (1, 25, 1),
    "fBonusRegenPct": (0, 200, 5),
    "fBonusThresholdPct": (0, 50, 5),
}
