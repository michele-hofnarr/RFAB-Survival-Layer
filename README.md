...
1. Закройте игру.
2. В Mod Organizer 2 **удалите** мод версии 0.4 целиком — правой кнопкой по
   нему в левой панели. Просто снять галочку **недостаточно**.
3. Запустите игру и загрузите своё сохранение. Игра предупредит, что
   сохранение использует недоступный контент, — согласитесь.
4. Оглядитесь. Шкал Сна, Сытости и Тепла на экране быть не должно, и в списке
   активных эффектов не должно остаться ничего от режима выживания.
5. **Сохранитесь в новый слот** — не поверх старого.
6. Закройте игру и установите 0.5 так же, как описано выше.
7. Запустите игру и загрузите сохранение из шага 5.
